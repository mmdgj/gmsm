...
func (hs *serverHandshakeStateGM) readClientHello() (isResume bool, err error) {
	...
	fmt.Println("PreferServerCipherSuites = ", c.config.PreferServerCipherSuites)
	fmt.Println("supportedList = ", supportedList)
	fmt.Println("preferenceList = ", preferenceList)
